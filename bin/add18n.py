...
controllers = "".join(open(gopath + '/src/github.com/davidrenne/asdineStormRocks/controllers/constants.go', 'r').readlines())
...
path = '/src/github.com/davidrenne/asdineStormRocks/web/app/globalization/translations/' + app + '/en/US.json'
...
if blastIt == "0" and key not in translations:
    ...
    if app == "app":
        translationGoCode = gopath + '/src/github.com/davidrenne/asdineStormRocks/queries/appTranslations.go'
