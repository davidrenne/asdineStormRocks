...
import (
	...
	"github.com/davidrenne/asdineStormRocks/scheduleEngine"
	"github.com/davidrenne/asdineStormRocks/settings"
	"github.com/davidrenne/asdineStormRocks/viewModel/socketViews"
...
func WriteLog(uniqueId string, message string) (err error) {
	...
	log := "src/github.com/davidrenne/asdineStormRocks/log/plugins/" + uniqueId + ".log"
	if uniqueId == "" {
		log = "src/github.com/davidrenne/asdineStormRocks/log/app.log"
	}
